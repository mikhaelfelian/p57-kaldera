                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <?= form_open('', ['method' => 'get', 'id' => 'filterForm']) ?>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?= form_label('Cari Kode/Merk:', 'search') ?>
                                        <div class="input-group">
                                            ...
                                            <?= form_input([
                                                ...
                                                'name' => 'search',
                                                'value' => $search ?? '',
                                                'placeholder' => 'Masukkan kode atau nama merk...',
                                                'data-toggle' => 'tooltip',
                                        ...
                                        <small class="form-text text-muted">
                                            ...
                                            Pencarian otomatis setelah 0.5 detik berhenti mengetik. <strong>Fokus pada kolom Merk</strong>
                                        </small>
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <a href="<?= base_url('master/merk') ?>" class="btn btn-secondary btn-sm">
...
$(document).ready(function() {
    ...
    // Highlight search terms in table - focus only on Merk column
    function highlightSearchTerms() {
        const searchTerm = $('#search').val().toLowerCase();
        if (searchTerm.length > 0) {
            $('tbody tr').each(function() {
                const row = $(this);
                // Only check the Merk column (3rd column, index 2)
                const merkCell = row.find('td:eq(2)'); // Merk column
                const merkText = merkCell.text().toLowerCase();
                if (merkText.includes(searchTerm)) {
