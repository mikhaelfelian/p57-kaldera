 ...
 * - $kategori: array of kategori data
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <?= form_open('', ['method' => 'get', 'id' => 'filterForm']) ?>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?= form_label('Cari Kode/Kategori:', 'keyword') ?>
                                        ...
                                        <small class="form-text text-muted">
                                            ...
                                            Pencarian otomatis setelah 0.5 detik berhenti mengetik. <strong>Fokus pada kolom Kategori</strong>
                                        </small>
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <a href="<?= base_url('master/kategori') ?>" class="btn btn-secondary btn-sm">
...
$(document).ready(function() {
    ...
    // Highlight search terms in table - focus only on Kategori column
    function highlightSearchTerms() {
        const searchTerm = $('#search').val().toLowerCase();
        if (searchTerm.length > 0) {
            $('tbody tr').each(function() {
                const row = $(this);
                // Only check the Kategori column (3rd column, index 2)
                const kategoriCell = row.find('td:eq(2)'); // Kategori column
                const kategoriText = kategoriCell.text().toLowerCase();
                if (kategoriText.includes(searchTerm)) {
