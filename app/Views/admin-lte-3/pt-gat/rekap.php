    ...
    <div class="col-md-9">
        <div class="card rounded-0">
            <div class="card-header d-flex align-items-center justify-content-between rounded-0" style="background-color: #dc3545; color: white;">
                <h3 class="card-title mb-0 font-weight-bold">PERSETUJUAN TEKNIS - SEKTOR GAT</h3>
            ...
            <div class="card-body rounded-0">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="<?= base_url('pt-gat/rekap/export-excel?year='.$year.'&bulan='.$bulan) ?>" 
                           class="btn btn-success rounded-0 mr-2">
                            <i class="fas fa-file-excel"></i> Export Excel
                        </a>
                        <a href="<?= base_url('pt-gat/rekap/export-pdf?year='.$year.'&bulan='.$bulan) ?>" 
