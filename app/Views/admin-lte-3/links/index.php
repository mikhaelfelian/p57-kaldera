    ...
    <div class="col-md-12">
        <div class="card rounded-0">
            <div class="card-header d-flex justify-content-between align-items-center rounded-0">
                <div>
                    <span class="mr-2">Tambah Link Web GIS</span>
                </div>
            ...
            <div class="card-body">
                <?= form_open('links/store', ['id' => 'linksForm', 'class' => 'mb-3']) ?>
                    <?= csrf_field() ?>
                    <div class="form-row">
...
$(function(){
    ...
    $(document).on('click', '.btn-delete', function(){
        ...
        const proceed = function(){
            $.post('<?= base_url('links/delete') ?>/' + id, {<?= json_encode(csrf_token()) ?>: '<?= csrf_hash() ?>'}, function(res){
