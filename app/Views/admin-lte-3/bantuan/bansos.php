                ...
                <tbody>
                    <tr>
                        <td class="font-weight-bold" style="background-color: #2f5f93; color: white;">
                            Monitoring Progres Bantuan Sosial yang diserahkan kepada masyarakat
                        </td>
                        <td class="text-center">
                            <div class="d-flex flex-column align-items-center">
                                <button type="button" class="btn btn-success btn-sm rounded-0 upload-data-btn" 
                                        data-jenis="monitoring_progres" data-label="Monitoring Progres Bantuan Sosial yang diserahkan kepada masyarakat"
...
(function(){
    ...
    $(document).on('click', '.preview-btn', function(){
        ...
        $.get('<?= base_url('bantuan/bansos/preview') ?>/' + id, function(res){
            if(res && res.ok){
                $('#preview_jenis_bansos').text(res.data.jenis_bansos || 'monitoring_progres');
    ...
    $('#uploadDataForm').on('submit', function(e){
        ...
        formData.append('nama_bansos', $('#data_keterangan').val());
