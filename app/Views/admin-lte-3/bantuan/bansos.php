...
<div class="card rounded-0">
    <div class="card-header d-flex align-items-center justify-content-between rounded-0">
        <h3 class="card-title mb-0">BANTUAN SOSIAL</h3>
        ...
        <div class="table-responsive rounded-0">
            <table class="table table-bordered rounded-0">
                <thead style="background-color: #3b6ea8; color: white;">
                    <tr>
                        <th style="width: 200px;">Jenis Bantuan Sosial</th>
                    ...
                    <tr>
                        <th></th>
                        <th class="text-center">Nama Bantuan Sosial</th>
                        <th class="text-center">Nilai Bantuan Sosial</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content rounded-0">
            <div class="modal-header" style="background-color: #3b6ea8; color: white;">
                <h5 class="modal-title" id="uploadDataModalLabel">Upload Data Bantuan Sosial</h5>
            ...
            <form id="uploadDataForm" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Jenis Bantuan Sosial</label>
                        <input type="text" class="form-control rounded-0" id="data_jenis_bansos" name="jenis_bansos" readonly>
                    </div>
                    <div class="form-group">
                        <label class="font-weight-bold">Nama Bantuan Sosial</label>
                        <input type="text" class="form-control rounded-0" id="data_nama_bansos" name="nama_bansos" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="uploadNilaiModal" tabindex="-1" role="dialog" aria-labelledby="uploadNilaiModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content rounded-0">
            <div class="modal-header" style="background-color: #3b6ea8; color: white;">
                <h5 class="modal-title" id="uploadNilaiModalLabel">Input Nilai Bantuan Sosial</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white;">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="uploadNilaiForm">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Jenis Bantuan Sosial</label>
                        <input type="text" class="form-control rounded-0" id="nilai_jenis_bansos" name="jenis_bansos" readonly>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content rounded-0">
            ...
            <form id="verifikasiForm">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Jenis Bantuan Sosial</label>
                        <input type="text" class="form-control rounded-0" id="verifikasi_jenis_bansos" name="jenis_bansos" readonly>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content rounded-0">
            ...
            <form id="feedbackForm">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Jenis Bantuan Sosial</label>
                        <input type="text" class="form-control rounded-0" id="feedback_jenis_bansos" name="jenis_bansos" readonly>
                    </div>
        ...
        <div class="modal-content rounded-0">
            ...
            <form id="uploadDokForm" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="font-weight-bold">Jenis Bantuan Sosial</label>
                        <input type="text" class="form-control rounded-0" id="dok_jenis_bansos" name="jenis_bansos" readonly>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-labelledby="previewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content rounded-0">
            <div class="modal-header" style="background-color: #3b6ea8; color: white;">
                <h5 class="modal-title" id="previewModalLabel">Preview Data Bantuan Sosial</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white;">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="font-weight-bold">Jenis Bantuan Sosial</label>
                            <p id="preview_jenis_bansos" class="form-control-plaintext"></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="font-weight-bold">Nama Bantuan Sosial</label>
                            <p id="preview_nama_bansos" class="form-control-plaintext"></p>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="font-weight-bold">Nilai Bantuan Sosial</label>
                            <p id="preview_nilai_bansos" class="form-control-plaintext"></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
(function(){
    ...
    $(document).on('click', '.upload-data-btn', function(){
        ...
        $('#data_jenis_bansos').val(jenis);
        $('#data_nama_bansos').val('');
        $('#data_deskripsi').val('');
    ...
    $(document).on('click', '.verifikasi-btn', function(){
        ...
        $('#verifikasi_jenis_bansos').val(jenis);
    ...
    $(document).on('click', '.feedback-btn', function(){
        ...
        $('#feedback_jenis_bansos').val(jenis);
    ...
    $(document).on('click', '.preview-btn', function(){
        ...
        $.get('<?= base_url('bantuan/bansos/preview') ?>/' + id, function(res){
            if(res && res.ok){
                $('#preview_jenis_bansos').text(res.data.jenis_bansos);
                $('#preview_nama_bansos').text(res.data.nama_bansos);
                $('#preview_deskripsi').text(res.data.deskripsi || '-');
                $('#preview_nilai_bansos').text(formatCurrency(res.data.nilai_bansos || 0));
    ...
    $(document).on('click', '#downloadBtn', function(){
        if(currentDataId){
            window.open('<?= base_url('bantuan/bansos/download') ?>/' + currentDataId, '_blank');
        }
    });
    ...
    $('#uploadDataForm').on('submit', function(e){
        ...
        var formData = {
            tahun: <?= $tahun ?>,
            bulan: <?= $bulan ?>,
            jenis_bansos: $('#data_jenis_bansos').val(),
            nama_bansos: $('#data_nama_bansos').val(),
            deskripsi: $('#data_deskripsi').val()
        };
        formData[csrfTokenName] = csrfHash;
        
        $.post('<?= base_url('bantuan/bansos/save') ?>', formData, function(res){
    ...
    $('#verifikasiForm').on('submit', function(e){
        ...
        var formData = {
            tahun: <?= $tahun ?>,
            bulan: <?= $bulan ?>,
            jenis_bansos: $('#verifikasi_jenis_bansos').val(),
    ...
    $('#feedbackForm').on('submit', function(e){
        ...
        var formData = {
            tahun: <?= $tahun ?>,
            bulan: <?= $bulan ?>,
            jenis_bansos: $('#feedback_jenis_bansos').val(),
            feedback_unit_kerja: {}
        };
    ...
    $('#uploadDokForm').on('submit', function(e){
        ...
        $.ajax({
            url: '<?= base_url('bantuan/bansos/upload') ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
