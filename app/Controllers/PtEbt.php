...
class PtEbt extends BaseController
{
    ...
    public function index()
    {
        ...
        $existingData = $this->ptModel->getByPeriode($year, $bulan, 'ebt');
        ...
        return $this->view($this->theme->getThemePath() . '/pt-ebt/input', $data);
    }
    ...
    public function saveData()
    {
        ...
        try {
            ...
            log_message('error', 'Error saving PT EBT data: ' . $e->getMessage());
            return $this->response->setJSON([
                'ok' => false,
    ...
    public function rekap()
    {
        ...
        $data = [
            'title' => 'Rekap Persetujuan Teknis - EBT',
            'year' => (int)$year,
            'bulan' => (int)$bulan,
            'rekapData' => $rekapData,
        ...
        return $this->view($this->theme->getThemePath() . '/pt-ebt/rekap', $data);
    }
    ...
    public function exportExcel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setTitle('Rekap Persetujuan Teknis - Sektor EBT')
            ->setDescription('Export data rekap persetujuan teknis sektor ebt');

        // Set headers
        $sheet->setCellValue('A1', 'REKAP PERSETUJUAN TEKNIS - SEKTOR EBT');
        ...
        // Set filename
        $filename = 'Rekap_PT_EBT_' . $year . '_' . str_pad($bulan, 2, '0', STR_PAD_LEFT) . '.xlsx';
    ...
    public function exportPdf()
    {
        ...
        $pdf->SetTitle('Rekap Persetujuan Teknis - Sektor EBT');
        $pdf->SetSubject('Export data rekap persetujuan teknis sektor ebt');
        ...
        $pdf->Cell(0, 10, 'REKAP PERSETUJUAN TEKNIS - SEKTOR EBT', 0, 1, 'C');
        ...
        $filename = 'Rekap_PT_EBT_' . $year . '_' . str_pad($bulan, 2, '0', STR_PAD_LEFT) . '.pdf';
