...
class PtMinerba extends BaseController
{
    ...
    public function exportExcel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setTitle('Rekap Persetujuan Teknis - Sektor Minerba')
            ->setDescription('Export data rekap persetujuan teknis sektor minerba');

        // Set headers
        $sheet->setCellValue('A1', 'REKAP PERSETUJUAN TEKNIS - SEKTOR MINERBA');
        ...
        // Set filename
        $filename = 'Rekap_PT_Minerba_' . $year . '_' . str_pad($bulan, 2, '0', STR_PAD_LEFT) . '.xlsx';
    ...
    public function exportPdf()
    {
        ...
        $pdf->SetTitle('Rekap Persetujuan Teknis - Sektor Minerba');
        $pdf->SetSubject('Export data rekap persetujuan teknis sektor minerba');
        ...
        $pdf->Cell(0, 10, 'REKAP PERSETUJUAN TEKNIS - SEKTOR MINERBA', 0, 1, 'C');
        ...
        $filename = 'Rekap_PT_Minerba_' . $year . '_' . str_pad($bulan, 2, '0', STR_PAD_LEFT) . '.pdf';
