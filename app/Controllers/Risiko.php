...
use App\Models\RisikoModel;

class Risiko extends BaseController
{
    protected $model;
    ...
    public function index()
    {
        ...
        return view($this->theme->getThemePath() . '/risiko/index', $data);
    }
    ...
    public function store()
    {
        ...
        if ($file && $file->isValid()) {
            ...
            $targetDir = FCPATH . '' . DIRECTORY_SEPARATOR . 'file' . DIRECTORY_SEPARATOR . 'risiko' . DIRECTORY_SEPARATOR . $id;
            if (!is_dir($targetDir)) {
                mkdir($targetDir, 0777, true);
            }
            $newName = 'risiko_' . $id . '_' . time() . '.' . $ext;
            $file->move($targetDir, $newName, true);
            $relative = '/file/risiko/' . $id . '/' . $newName;
        ...
        return redirect()->to(base_url('risiko'))->with('success', 'Data tersimpan');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to(base_url('risiko'))->with('success', 'Data dihapus');
    }
}
