...
class PtGatrik extends BaseController
{
    ...
    public function rekap()
    {
        ...
        $ptData = $this->ptModel->getByPeriode($year, $bulan, 'gatrik');
    ...
    public function exportExcel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setTitle('Rekap Persetujuan Teknis - Sektor Gatrik')
            ->setDescription('Export data rekap persetujuan teknis sektor gatrik');

        // Set headers
        $sheet->setCellValue('A1', 'REKAP PERSETUJUAN TEKNIS - SEKTOR GATRIK');
        ...
        // Set filename
        $filename = 'Rekap_PT_Gatrik_' . $year . '_' . str_pad($bulan, 2, '0', STR_PAD_LEFT) . '.xlsx';
    ...
    public function exportPdf()
    {
        ...
        $pdf->SetTitle('Rekap Persetujuan Teknis - Sektor Gatrik');
        $pdf->SetSubject('Export data rekap persetujuan teknis sektor gatrik');
        ...
        $pdf->Cell(0, 10, 'REKAP PERSETUJUAN TEKNIS - SEKTOR GATRIK', 0, 1, 'C');
        ...
        $filename = 'Rekap_PT_Gatrik_' . $year . '_' . str_pad($bulan, 2, '0', STR_PAD_LEFT) . '.pdf';
